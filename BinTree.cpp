...
// ------------------------------------retrieve----------------------------------------------- 
// Description
// retrieve(const Movie*& target, Movie*& toFind): Finds the target movie in the tree
// preconditions: none
//
...
// ------------------------------------DisplayHelper----------------------------------------------- 
// Description
// EmptyHelper(*Node curr): Helper method to print out the tree. Does an in order traversal
